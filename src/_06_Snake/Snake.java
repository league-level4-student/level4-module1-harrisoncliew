...
public class Snake {
	...
	public void update() {
		...
		case UP :
			loc = new Location(getHeadLocation().x, getHeadLocation().y+1);
			break;
		case DOWN :
			loc = new Location(getHeadLocation().x, getHeadLocation().y-1);
			break;
		case LEFT :
			loc = new Location(getHeadLocation().x-1, getHeadLocation().y);
			break;
		case RIGHT :
			loc = new Location(getHeadLocation().x+1, getHeadLocation().y);
	...
	public boolean isHeadCollidingWithBody() {
		...
		System.out.println("this is the one being called");
